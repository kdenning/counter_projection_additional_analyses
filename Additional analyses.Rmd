...
```{r data set-up for coeff downstream analysis for binding}
#getting the coefficients from initial study with stereotyping
...
```{r data set-up for coeff downstream analysis for indiv}
#getting the coefficients from initial study with stereotyping
